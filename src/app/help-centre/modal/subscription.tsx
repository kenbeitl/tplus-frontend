...
const DIALOG_CARD = [
  {
    id: "1", title: "iAM Smart", userType: "Local Individuals", description: "Hong Kong government digital identity for residents",
    features: [
  ...
  {
    id: "2", title: "iD-One", userType: "Global Individuals", description: "International digital identity for global users",
    features: [
  ...
  {
    id: "3", title: "CorpID", userType: "Local Corporations", description: "Hong Kong corporate digital identity",
    features: [
  ...
  {
    id: "4", title: "iCorp-One", userType: "Global Corporations", description: "International corporate digital identity",
    features: [
...
export default function ModalSubscription({ open, onClose }: ModalProps) {
  return (
    <InfoModal
      open={open}
      onClose={onClose}
